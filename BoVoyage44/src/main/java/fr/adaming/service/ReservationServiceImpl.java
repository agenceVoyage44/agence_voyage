...
public class ReservationServiceImpl implements IReservationService {
	...
	public Reservation addReservation(Reservation reservation)
			throws AddressException, MessagingException, MalformedURLException, IOException {
...
//					"C:/Users/inti-0257/Desktop/Reservation_voyage_" + reservation.getId() + ".pdf"));
...
//			Phrase phrase = new Phrase("Liste des produits commandés");
//
...
//			Phrase phrase2 = new Phrase("Vous partez avec :");
//
...
//				table.addCell(listePart.get(i).getCivilite() + " " + listePart.get(i).getNom() + " "
//						+ listePart.get(i).getPrenom());
//				table.addCell(listePart.get(i).getDateNaissance().toString());
//				table.addCell(listePart.get(i).getNumero() + " " + listePart.get(i).getRue() + " "
...
//		document.close();
		...
		msg.setText("Vous avez effectué une réservation pour partir en " + reservation.getVoyage().getPays() + " du "
				+ reservation.getVoyage().getDateDepart() + " au " + reservation.getVoyage().getDateRetour());
		msg.setText(
				"Pensez à valider votre séjour : \n http://localhost:8080/BoVoyage44/boVoyage/reservation/client/liste");
		//multipart.addBodyPart(messageBodyPart);

		//messageBodyPart = new MimeBodyPart();
		//DataSource source = new FileDataSource("C:/Users/inti-0257/Desktop/Reservation_voyage_" + reservation.getId() + ".pdf");
