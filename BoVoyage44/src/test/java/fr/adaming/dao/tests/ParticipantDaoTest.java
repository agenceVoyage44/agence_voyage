...
// @Before
// public void setUp() {
// // p = new Participant("TOTO", "Titi", 1236547896, "M", 3, "rue des
// // chenes", 44000, "Nantes", "France",
// // new Date(1996 - 04 - 18));
// // p2 = new Participant("FOUFOU", "Titi", 1236547896, "M", 3, "rue des
// // chenes", 44000, "Nantes", "France",
// // new Date(1996 - 04 - 18));
// }
//
...
// assertEquals(tailleAvant + 2,
// participantDao.getAllParticpantIDResaNULL().size());
